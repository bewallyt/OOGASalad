...
public class GameFrame extends RPGEngine {
	...
	public void addObjects(World world) {
		...
		NPC bafm = myNPC = new NPC(new String[] { "rival.png", "rival.png",
	...
	public void addObjects2() {
		...
		// extract relevant data from myWorldData
	...
	private void initPlayer() {
		...
		String[] anim = new String[] { "PlayerUp0.png", "PlayerUp1.png",
				...
				"PlayerLeft2.png" };
		// String[] anim = new String[]{"PlayerUp0.png", "PlayerRight0.png",
		// "PlayerDown0.png", "PlayerLeft0.png"};
